...
**36 mutant:** 8'inin ham çıktısı KANIT'ta; kalan 28 **Claude Code transkriptinden** (9.124.995 b) Cowork'ün kendi ayrıştırmasıyla doğrulandı (36/36'da uygulama + başarısızlık izi). 🟡 Bu **yakınlık** ölçer, nedensellik kanıtlamaz. Sınıf **K67'de mekanikleşti**; ayrıntı arşivde.
